...
Sim.prototype.dotOn = function (num) {
    this.indicatorDotsAll[parseInt(num)].style.cssText = 'background-color:#fff; cursor:pointer;'
};

Sim.prototype.dotOff = function (num) {
    this.indicatorDotsAll[parseInt(num)].style.cssText = 'background-color:#497952; cursor:default;'
};
